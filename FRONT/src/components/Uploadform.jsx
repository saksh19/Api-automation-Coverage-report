...
//         <button class="btn-close" onClick={handleOpenForm}>
//       <svg
...
//     <p>or</p></>}
//     <span class="browse-button">{file?file.name:"Browse file"} </span>
//   </div>
...
//                   <button className=' rounded-md px-2 py-2 bg-blue-600 text-white' onClick={swag}>Click to test</button>
//             <h3 className='absolute left-1/2 transform -translate-x-1/2 font-semibold text-xl'>Uploaded API Endpoints:{file?file.name:""}</h3>
//             <div className='flex justify-end'>
//               <h1 className='font-semibold text-xl'> Total Uploaded Endpoints: {endpoints.length}</h1>
//             </div>
//            </div>
...
//           <div
//             key={index}
//             className={`p-2 m-2 border rounded  ${api.covered ? 'bg-green-200' : 'bg-red-200'}`}
//           >
//             <div className='flex'>
